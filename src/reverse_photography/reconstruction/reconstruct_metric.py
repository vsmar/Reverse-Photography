...
Run (from the repo root, no cameras needed):
    python src/reverse_photography/reconstruction/reconstruct_metric.py <run_name>
"""
import os
import sys
import numpy as np
...
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))      # .../src/reverse_photography/reconstruction
